<%-- 
    Document   : index
    Created on : 16/04/2020, 11:32:04 AM
    Author     : MyPc
--%>
                                    ...
                                    <form id="FrmCategoria">
                                        <div class ="row mt-3">
                                            ...
                                            <div class="col-sm-3 col-12">
                                                <button type ="submit" id="btnBuscarCategoria" class="btn btn-rounded btn-danger mb-3 btn-xs mr-2" ><i class="fa fa-search" aria-hidden="true"></i> BUSCAR</button> 
                                                <button type ="button" id="btnAbrirCategoria" class="btn btn-rounded btn-danger mb-3 btn-xs" ><i class="fa fa-plus" aria-hidden="true"></i></button> 
